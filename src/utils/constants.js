...
export const EGALIM_OBJECTIVES = {
  ...
  viandes_egalim: 100, // 100% viandes/volailles EGAlim (objectif 2024)
  viandes_france: 60   // Encouragement produits français
};

// Seuils d'alerte pour le code couleur des jauges
export const EGALIM_THRESHOLDS = {
  critical: 0.5,  // < 50% de l'objectif = rouge
  warning: 0.8    // < 80% de l'objectif = orange, >= 80% = vert
};

// Mapping des noms de ministères (data.gouv.fr) vers les valeurs API ma-cantine
export const MINISTRY_API_MAPPING = {
  "Affaires étrangères": "affaires_etrangeres",
  "Agriculture, Alimentation et Forêts": "agriculture",
  "Armées": "armee",
  "Cohésion des territoires - Relations avec les collectivités territoriales": "territoires",
  "Culture": "culture",
  "Économie et finances": "economie",
  "Éducation et Jeunesse": "jeunesse",
  "Enseignement supérieur et Recherche": "enseignement_superieur",
  "Environnement": "ecologie",
  "Fonction Publiques": "transformation",
  "Intérieur et Outre-mer": "interieur",
  "Justice": "justice",
  "Mer": "mer",
  "Préfecture - Administration Territoriale de l'État (ATE)": "administration_territoriale",
  "Présidence de la république - Autorités indépendantes (AAI, API)": "autorites_independantes",
  "Services du Premier Ministre": "premier_ministre",
  "Santé et Solidarités": "sante",
  "Sport": "sport",
  "Travail": "travail"
};
